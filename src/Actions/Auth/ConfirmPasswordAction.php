...
{
    public function __invoke(StatefulGuard $guard, $user, null|string $password = null): bool
    {
    ...
    protected function confirmPasswordUsingCustomCallback($user, null|string $password = null): bool
    {
