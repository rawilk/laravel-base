...
<div>
    ...
    <div class="bg-white border shadow-sm lg:flex lg:divide-x lg:divide-x-blue-gray-200 divide-y divide-y-blue-gray-200 lg:divide-y-0">
        {{-- search --}}
                        ...
                        <div class="flex-shrink-0 pl-1.5">
                            <x-tooltip title="{!! __('laravel-base::messages.filters.trigger_button_tooltip') !!}">
                                <button
                                    ...
                                    type="button"
                                    class="p-2 rounded-full hover:bg-blue-gray-200 group focus:ring-2 focus:ring-offset-1 focus:ring-blue-500 focus:ring-opacity-50 focus:outline-none transition-colors"
                                >
                                    <x-heroicon-s-filter class="w-4 h-4 text-blue-gray-500 group-hover:text-blue-gray-600 transition-colors" />
                                </button>
                            </x-tooltip>
                        </div>
                    @endif
