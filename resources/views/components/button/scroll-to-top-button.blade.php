<div x-data="scrollToTopButton" class="scroll-to-top-button | absolute top-0 right-0 h-screen w-screen pointer-events-none">
    <button
        ...
        {{ $attributes->class('rounded-full bg-blue-gray-500 hover:bg-blue-gray-700 text-white p-3 fixed bottom-5 right-5 pointer-events-auto transition duration-100 ease-css') }}
    >
